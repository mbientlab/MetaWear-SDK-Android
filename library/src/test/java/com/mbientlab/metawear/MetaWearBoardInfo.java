...
public class MetaWearBoardInfo {
    ...
    public MetaWearBoardInfo(String name, String modelNumber, String hardwareRevision, byte[][] moduleResponsesArray) {
        this.name= name;
    ...
    DETECTOR= new MetaWearBoardInfo("detector", "2", "0.2", new byte[][] {
            {0x01, (byte) 0x80, 0x00, 0x00},
            {0x02, (byte) 0x80, 0x00, 0x00},
            {0x03, (byte) 0x80, 0x03, 0x01},
            {0x04, (byte) 0x80, 0x01, 0x00, 0x00, 0x03, 0x01, 0x02},
            {0x05, (byte) 0x80, 0x00, 0x01, 0x03, 0x03, 0x03, 0x03, 0x01},
            {0x06, (byte) 0x80, 0x00, 0x00},
            {0x07, (byte) 0x80, 0x00, 0x00},
            {0x08, (byte) 0x80, 0x00, 0x00},
            {0x09, (byte) 0x80, 0x00, 0x00, 0x1c},
    ...
    ENVIRONMENT= new MetaWearBoardInfo("environment", "2", "0.2", new byte[][] {
            {0x01, (byte) 0x80, 0x00, 0x00},
            {0x02, (byte) 0x80, 0x00, 0x00},
            {0x03, (byte) 0x80, 0x03, 0x01},
            {0x04, (byte) 0x80, 0x01, 0x00, 0x00, 0x03, 0x01, 0x02},
    ...
    RPRO= new MetaWearBoardInfo("rpro", "1", "0.3", new byte[][] {
            {0x01, (byte) 0x80, 0x00, 0x00},
            {0x02, (byte) 0x80, 0x00, 0x00},
            {0x03, (byte) 0x80, 0x01, 0x01},
            {0x04, (byte) 0x80, 0x01, 0x00, 0x00, 0x03, 0x01, 0x02},
    ...
    R= new MetaWearBoardInfo("r", "0", "0.2", new byte[][] {
            {0x01, (byte) 0x80, 0x00, 0x00},
            {0x02, (byte) 0x80, 0x00, 0x00},
    ...
    RG= new MetaWearBoardInfo("rg", "1", "0,2", new byte[][] {
            {0x01, (byte) 0x80, 0x00, 0x00},
            {0x02, (byte) 0x80, 0x00, 0x00},
            {0x03, (byte) 0x80, 0x01, 0x01},
            {0x04, (byte) 0x80, 0x01, 0x00, 0x00, 0x03, 0x01, 0x02},
    ...
    MOTIOON_R= new MetaWearBoardInfo("motionr", "5", "0,1", new byte[][] {
            {0x01, (byte) 0x80, 0x00, 0x00},
            {0x02, (byte) 0x80, 0x00, 0x00},
            {0x03, (byte) 0x80, 0x01, 0x01},
            {0x04, (byte) 0x80, 0x01, 0x00, 0x00, 0x03, 0x01, 0x02},
