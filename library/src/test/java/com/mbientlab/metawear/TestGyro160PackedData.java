 ...
 */
public class TestGyro160PackedData extends UnitTestBase {
    private Gyro gyro;
    ...
    public void interpretPackedData() throws InterruptedException {
        ...
        setup().addOnSuccessListener(IMMEDIATE_EXECUTOR, ignored -> {
            gyro = mwBoard.getModule(GyroBmi160.class);
            gyro.packedAngularVelocity().addRouteAsync(source -> source.stream((data, env) -> ((ArrayList<AngularVelocity>) env[0])
