...
/**
 * Generic class providing high level access to a barometer sensor.  If you know specifically which MetaWear
 * board you are using, use the appropriate Barometer subclass.
 * @author Eric Tsai
 * @see Bmp280Barometer
 */
public interface Barometer extends MetaWearBoard.Module {
    ...
    interface SourceSelector {
         ...
         * @return Object representing the pressure data
         */
        DataSignal fromPressure();
        /**
         * Handle altitude data from the sensor
         * @return Object representing the altitude data
         */
