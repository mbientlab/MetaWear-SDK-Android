...
/**
 * Controls the TSL2671 proximity detector.  This sensor is only available on
 * MetaDetector boards.
 * @author Eric Tsai
 */
public interface Tsl2671Proximity extends MetaWearBoard.Module {
    ...
    interface ConfigEditor {
         ...
         * @return Calling object
         */
        ConfigEditor setPulseCount(byte nPulses);
        /**
         * Sets the photodiode for responding to light
         * @param diode    Photodiode to use
         * @return Calling object
         */
        ConfigEditor setReceiverDiode(ReceiverDiode diode);
        /**
         * Sets the led drive current.  For boards powered by the CR2032 battery, it is recommended to use 25mA or less.
         * @param driveCurrent    Current driving the sensor
         * @return Calling object
         */
        ConfigEditor setTransmitterDriver(TransmitterDrive driveCurrent);
        /**
    ...
    /**
     * Selector for proximity sensor data sources
     * @author Eric Tsai
     */
    interface SourceSelector {
        /**
         * Handle data from the proximity sensor
         * @param silent    Same value as the silent parameter for calling {@link #readProximity(boolean)}
     ...
     * @param silent    True if the read is silent
     */
    void readProximity(boolean silent);
    /**
