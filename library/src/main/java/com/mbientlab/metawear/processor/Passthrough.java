...
public class Passthrough implements DataSignal.ProcessorConfig {
    ...
    public static class State implements DataProcessor.State {
         ...
         * @param newValue    New value to set the filter to, which will have different effects depending
         *                    on the operation mode
         * @see com.mbientlab.metawear.processor.Passthrough.Mode
         */
        public State(short newValue) {
    ...
    /**
     * Constructs a passthrough config object from a URI string
