...
class GyroBmi270Impl extends GyroImpl implements GyroBmi270 {
    ...
    private final static byte DATA_INTERRUPT_ENABLE = 2, DATA = 4, PACKED_DATA= 0x5;
    private final static String ROT_PRODUCER= "com.mbientlab.metawear.impl.GyroBmi270Impl.ROT_PRODUCER",
            ROT_X_AXIS_PRODUCER= "com.mbientlab.metawear.impl.GyroBmi270Impl.ROT_X_AXIS_PRODUCER",
            ROT_Y_AXIS_PRODUCER= "com.mbientlab.metawear.impl.GyroBmi270Impl.ROT_Y_AXIS_PRODUCER",
            ROT_Z_AXIS_PRODUCER= "com.mbientlab.metawear.impl.GyroBmi270Impl.ROT_Z_AXIS_PRODUCER",
            ROT_PACKED_PRODUCER= "com.mbientlab.metawear.impl.GyroBmi270Impl.ROT_PACKED_PRODUCER";
    ...
    private static class BoschGyrCartesianFloatData extends FloatVectorData {
        ...
        public DataTypeBase copy(DataTypeBase input, Constant.Module module, byte register, byte id, DataAttributes attributes) {
            return new GyroBmi270Impl.BoschGyrCartesianFloatData(input, module, register, id, attributes);
        }

        @Override
        public DataTypeBase[] createSplits() {
            return new DataTypeBase[] {new GyroBmi270Impl.BoschGyrSFloatData((byte) 0), new GyroBmi270Impl.BoschGyrSFloatData((byte) 2), new GyroBmi270Impl.BoschGyrSFloatData((byte) 4)};
        }
    ...
    private static class BoschGyrSFloatData extends SFloatData {
        ...
        @Override
        public DataTypeBase copy(DataTypeBase input, Constant.Module module, byte register, byte id, DataAttributes attributes) {
            return new GyroBmi270Impl.BoschGyrSFloatData(input, module, register, id, attributes);
        }
    }

    GyroBmi270Impl(MetaWearBoardPrivate mwPrivate) {
        super(mwPrivate);
