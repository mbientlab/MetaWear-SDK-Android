...
public class MwrAccelAxisMessage extends Message {
    public interface AxisG {
        public float x();
        public float y();
        public float z();
    }

    public interface AxisMilliG {
        public short x();
        public short y();
        public short z();
    }
    ...
    public <T> T getData(Class<T> type) {
        if (type.equals(AxisG.class)) {
            return type.cast(new AxisG() {
                @Override
                public float x() {
                    return accelGs[0];
                }
        ...
        } else if (type.equals(AxisMilliG.class)) {
            return type.cast(new AxisMilliG() {
                @Override
                public short x() {
                    return milliGs[0];
                }
