...
/**
 * Enumeration of GATT characteristics specific to the MetaWear service
 * @author Eric Tsai
 * @see GATTService#METAWEAR
 */
public enum MetaWear implements GATTCharacteristic {
    ...
    private MetaWear(String uuidPart) {
        this.uuid= UUID.fromString(String.format("326A%s-85CB-9195-D9DD-464CFBBAE75A", uuidPart));
    }
